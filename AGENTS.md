...
- **Comentarios en código:** Solo en métodos públicos complejos con Javadoc + comentarios inline para lógica no-obvia. En servicios: documentar QUÉ hace, CÓMO lo hace (parámetros), y EFECTOS (BD, errores). En helpers privados: Javadoc corto. NO comentar código obvio.
